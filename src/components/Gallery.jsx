        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">
                    Sanchayan Gallery Conrner
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {images.map((image) => (
                        <div key={image.id} className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all hover:scale-105">
                            <img 
                                src={image.src} 
                                alt={image.alt}
                            ...
                            />
                            <div className="p-4">
                                <h3 className="text-xl font-semibold text-gray-700 text-center">{image.title}</h3>
                            </div>
                        </div>
                    ))}
                </div>
